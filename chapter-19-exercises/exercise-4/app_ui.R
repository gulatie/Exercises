...
ui <- navbarPage(
  ...
  tabPanel(
    ...
    # the US."
    p("The below diagram was created by the New York Times to illustrate the increasing inequality in the US."),
    ...
    # text.
    p(
      "The graph shows how the richest 1% of peopple have seen thier incomes jump",
      strong("6%"),
      "since 1980",
    ...
    p('Click on the "Growth Chart" tab to see an alternative interavtive diagram.')
  ),
